          ...
          <div className="flex flex-col md:flex-row items-center p-10 md:p-16 gap-12">
            ...
            <div className="flex-1 w-full">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:justify-start justify-center">
                ...
                <a href="mailto:deilariess0@gmail.com" target="_blank" rel="noopener className="flex items-center justify-center gap-2 bg-blue-600/10 text-blue-600 border border-blue-600/30 px-6 py-3 rounded-xl font-semibold hover:bg-blue-600 hover:text-white transition whitespace-nowrap w-full sm:w-auto">
