      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        <div>
          ...
          <div className="space-y-6 mt-10 text-slate-300">
            <div className="flex items-center gap-4"><i className="fas fa-envelope text-blue-400"></i>deilaries@gmail.com</div>
        ...
        <form className="space-y-4">
          ...
          <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 py-4 rounded-xl font-bold hover:opacity-90 transition flex justify-center items-center gap-2">
